...
#====================================================================
s.source           = { :git => 'https://github.com/iOS-Risenb/HR_DIR.git', :tag => s.version.to_s }
...
#====================================================================
# 'h,m' 之间不能有空格
s.source_files = 'HR_DIR/Classes/**/*.{h,m}'


# 3.3:资源文件
#====================================================================
# 'HR_DIR' 为存储的 bundleName
#s.resource_bundles = {
#    'HR_DIR' => ['HR_DIR/**/*.{storyboard,xib,png,plist}']
#}
